...
public final class MarkdownRenderer {
    ...
    public static String renderDailyPage(String channelName, LocalDate date, List<Row> rows) {
    ...
    public static String renderChannelIndex(String channelName, List<LocalDate> dates) {
        StringBuilder builder = new StringBuilder();
        builder.append("---\n");
    ...
    public static String renderGlobalIndex(List<String> channels) {
        StringBuilder builder = new StringBuilder();
        builder.append("---\n");
    ...
    public record Row(String time, String user, String message, String permalink) {
    }
}
