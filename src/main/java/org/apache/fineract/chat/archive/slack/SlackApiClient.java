...
public final class SlackApiClient {
    ...
    public AuthTestResponse authTest(String token) throws IOException, InterruptedException {
    ...
    public ConversationsListResponse listPublicChannels(String token)
    ...
    public ConversationsHistoryResponse listChannelMessages(String token, String channelId,
    ...
    public ConversationsRepliesResponse listThreadReplies(String token, String channelId,
            String threadTs)
            throws IOException, InterruptedException {
        List<SlackMessage> messages = new ArrayList<>();
        String cursor = null;
    ...
    public PermalinkResponse getPermalink(String token, String channelId, String messageTs)
            throws IOException, InterruptedException {
    ...
    public record AuthTestResponse(boolean ok, String error, String team, String user) {
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record ConversationsListResponse(boolean ok, String error, List<SlackChannel> channels,
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record ResponseMetadata(@JsonProperty("next_cursor") String nextCursor) {
    }
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record ConversationsHistoryResponse(boolean ok, String error, List<SlackMessage> messages,
            @JsonProperty("response_metadata") ResponseMetadata responseMetadata) {
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record ConversationsRepliesResponse(boolean ok, String error, List<SlackMessage> messages,
            @JsonProperty("response_metadata") ResponseMetadata responseMetadata) {
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record PermalinkResponse(boolean ok, String error, String permalink) {
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record UserInfoResponse(boolean ok, String error, SlackUser user) {
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record SlackUser(String id, String name, SlackProfile profile) {
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public record SlackProfile(@JsonProperty("display_name") String displayName,
